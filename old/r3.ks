function CalcHoffmantransfer{
    ...
    //set soi to (target:altitude).
    //set transferAp to positiontarget:mag.
    set soi to (tgtbody:altitude).
    set transferAp to body:radius + target:altitude.
